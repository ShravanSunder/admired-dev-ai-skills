...
- **Preserve:** security subset for `ops-security-review`; skill-creator anatomy as platform support
- **Avoid:** promoting the full curated catalog as general workflow sources; treating scaffolding as authoring philosophy; diluting normal review lanes with security-heavy process

## Open gaps

- [ ] List exact security skill paths on next security audit
