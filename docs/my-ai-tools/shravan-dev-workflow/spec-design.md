...
- **ai-tools path:** `/Users/shravansunder/dev/ai-tools/plugins/shravan-dev-workflow/skills/spec-design/`
- **Plugin:** shravan-dev-workflow
- **Last reviewed:** 2026-08-27
- **Renamed from:** `spec-creation-swarm` (retired in ai-tools). Owns Why/What (Requirements + observable Specification), not structural How.
